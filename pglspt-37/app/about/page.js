...
export default function About() {
  return (
    <div className="">
      <section className="flex flex-col items-center justify-center sm:h-screen bg-fixed bg-center bg-cover custom_img">
        <div className='absolute bg-[#000F34]/80 z-[2] h-[128%] md:h-screen w-full ' />
          <div className="z-[3] flex flex-col items-center justify-center mt-[8rem] mb-[2rem] md:mt-8 md:mb-0">
      ...
      <section className="flex flex-col items-center justify-center sm:h-screen bg-fixed bg-center bg-cover custom_img_2">
        <div className='absolute bg-[#000F34]/80 z-[2] h-[90%] md:h-screen w-full ' />
