import Cuyno from "@/public/images/officers/Cuyno.jpg"
import Utay from "@/public/images/officers/Utay.jpg"
import Carungay from "@/public/images/officers/Carungay.jpg"
import Castillo from "@/public/images/officers/Castillo.jpg"
import Calma from "@/public/images/officers/Calma.jpg"
import Bosque from "@/public/images/officers/Bosque.jpg"
import Yu from "@/public/images/officers/Yu.jpg"
import Rosales from "@/public/images/officers/Rosales.jpg"
...
import Salazar from "@/public/images/officers/Salazar.jpeg"
...
import Capin from "@/public/images/officers/Capin.jpg"
import Rivamonte from "@/public/images/officers/Rivamonte.jpg"
import Serrano from "@/public/images/officers/Serrano.jpg"
import Franco from "@/public/images/officers/Franco.jpg"
import Dioso from "@/public/images/officers/Dioso.jpg"
import Tino from "@/public/images/officers/Tino.jpg"
import David from "@/public/images/officers/David.jpg"
import Pinar from "@/public/images/officers/Pinar.jpg"
import Borres from "@/public/images/officers/Borres.jpg"
import Lacuna from "@/public/images/officers/Lacuna.jpg"
import Abool from "@/public/images/officers/Abo-ol.jpg"
import Diwa from "@/public/images/officers/Diwa.jpg"
import Dy from "@/public/images/officers/Dy.jpg"
...
export const deputiesDepartmentData = [
    {
        "title" : "Deputies to the Office of the President",
        "officers" : [
            {
                "name": "Hyacinth Lei Cuyno",
    ...
    },
    {
        ...
        "officers" : [
            ...
            {
                "name": "Filfred Kaizzer Calma",
                "position": "Internal Undersecretary",
                "img":Calma
            }
        ]
    },
    {
        "title" : "Deputies to the Office of the External Vice-President",
        "officers" : [
            {
                "name": "Ma. Marvie Bosque",
                "position": "External Secretary",
                "img":Bosque
            },
            {
                "name": "Karylle Mae Yu",
                "position": "External Undersecretary",
                "img":Yu
            }
        ]
    },
    ...
    {
        "title" : "Department Directors of the President",
        "officers" : [
            {
                "name": "Jet Lemuel Salazar",
                "position": "Political Affairs Director",
                "img":Salazar
            },
            {
                "name": "Adrian Neil Jamila",
                "position": "Advocacy and Community Extension Director",
                "img":Jamila
            },
            {
                "name": "Philip Jayson Lestojas",
                "position": "Advocacy and Community Extension Deputy Director",
                "img":Lestojas
            },
            {
                "name": "Ayn Lantingan",
            ...
            },
            {
                ...
                "position": "Memberships Director",
                "img":Ruiz
            },
            {
                "name": "Phelix Bartolome",
                "position": "Memberships Deputy Director",
                "img":Bartolome
            },
            {
                "name": "Jewel Batoon",
    ...
    },
    {
        ...
        "officers" : [
            ...
            {
                "name": "Granil Khate Dioso",
                "position": "Disaster Risk Reduction and Management Director",
                "img":Dioso
            },
            {
                "name": "Vanessa Tino",
                "position": "Disaster Risk Reduction and Management Deputy Director",
                "img":Tino
            }
        ]
    },
    {
        "title" : "Department Directors of the External Vice-President",
        "officers" : [
            {
                "name": "Enrico Daniel David",
                "position": "Partnerships and Linkages Director",
                "img":David
            },
            {
            ...
            {
                "name": "Jeanna Rein Borres",
                "position": "Publications Director / Editor-in-Chief",
                "img":Borres
            },
            {
            ...
            {
                "name": "Odyssey Mhel Abo-ol",
                "position": "Alumni Affairs Director",
                "img":Abool
            },
            {
                "name": "Nicole Diwa",
                "position": "Alumni Affairs Deputy Director",
                "img":Diwa
            }
        ]
    },
    {
        "title" : "Department Directors of the Secretary-General",
        "officers" : [
            {
                "name": "Pam Danica Dy",
            ...
            {
                "name": "Rustom Jordan Olaso",
                "position": "Communications Deputy Director",
                "img":Olaso
            },
            {
                "name": "Xianne Dereka Dacera",
                "position": "Productions Director",
                "img":Dacera
            },
            {
                "name": "Jeahan Kabalu",
                "position": "Productions Deputy Director",
                "img":Kabalu
            }
        ]
    },
    {
        ...
        "officers" : [
            ...
            {
                "name": "Desiree Veneracion",
                "position": "Video Assistant Head",
                "img":Veneracion
            },
            {
                "name": "Seanne Jayectin",
                "position": "Graphics Head",
                "img":Jayectin
            },
            {
                "name": "Jolinna Marie Yncierto",
                "position": "Graphics Assistant Head",
                "img":Yncierto
            },
            {
                "name": "Riel Rafael Calzada",
                "position": "Motion Graphics Head",
                "img":Calzada
            },
            {
            ...
            {
                "name": "Lisa Marie Mesiona",
                "position": "Photo Assistant Head",
                "img":Mesiona
            },
            {
                "name": "April Riane Miranda",
                "position": "Technicals Head",
                "img":Miranda
            },
            {
                "name": "Kaye Delosa Gomez",
                "position": "Technicals Assistant Head",
                "img":Gomez
            }
        ]
    },
    {
        ...
        "officers" : [
            ...
            {
                "name": "Denise Maxyn Amarga",
                "position": "Sponsorships Deputy Director",
                "img":Amarga
            },
            {
